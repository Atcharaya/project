 ...
 * {@link Edit_Status_Quest.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Edit_Status_Quest#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Edit_Status_Quest extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_edit__status__quest, container, false);
        recyclerView = view.findViewById(R.id.rv_edit_status_quest);
...
////    }
    ...
    public void getSaveList() {
        retrofit2.Call<List<EditStatusDao>> call = HttpManager.getInstance().getService().getSaveReportQuest();
