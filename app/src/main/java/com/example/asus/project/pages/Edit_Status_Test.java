 ...
 * {@link Edit_Status_Test.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Edit_Status_Test#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Edit_Status_Test extends Fragment {
    ...
    public static Edit_Status_Test newInstance(String param1) {
        Edit_Status_Test fragment = new Edit_Status_Test();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_edit__status__test, container, false);
        recyclerView = view.findViewById(R.id.rv_edit_status_test);
...
////    }
    ...
    public void getSaveList() {
        Call<List<SiteEditDao>> call = HttpManager.getInstance().getService().getSaveReportById("4");
