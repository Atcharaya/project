 ...
 * {@link Edit_Status_Done.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Edit_Status_Done#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Edit_Status_Done extends Fragment {
     ...
     * @return A new instance of fragment Edit_Status_Done.
     */
    // TODO: Rename and change types and number of parameters
    public static Edit_Status_Done newInstance(String param1, String param2) {
        Edit_Status_Done fragment = new Edit_Status_Done();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_edit__status__done, container, false);
        recyclerView = view.findViewById(R.id.rv_edit_status_done);
...
//    }
    ...
    public void getSaveList() {
        retrofit2.Call<List<EditAndSaveStatusDao>> call = HttpManager.getInstance().getService().getSaveReportDone();
