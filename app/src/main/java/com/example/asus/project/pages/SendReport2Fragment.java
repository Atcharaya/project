...
public class SendReport2Fragment extends Fragment {
    ...
    public static SendReport2Fragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Fragment fragment = new SendReport3Fragment();
        ...
        prevButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Fragment fragment = new SendReportFragment();
                ((MainActivity) getActivity()).changePage(fragment);
            }
        });
        return view;
