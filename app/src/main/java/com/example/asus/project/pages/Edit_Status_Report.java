 ...
 * {@link Edit_Status_Report.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Edit_Status_Report#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Edit_Status_Report extends Fragment {
    ...
    private Edit_Status_Report.OnFragmentInteractionListener mListener;

    public Edit_Status_Report() {
    ...
    public static Edit_Status_Report newInstance(String param1) {
        Edit_Status_Report fragment = new Edit_Status_Report();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_edit__status__report, container, false);
        recyclerView = view.findViewById(R.id.rv_edit_status_report);
...
////        if (context instanceof Edit_Status_Edit.OnFragmentInteractionListener) {
////            mListener = (Edit_Status_Edit.OnFragmentInteractionListener) context;
////        } else {
...
////    }
    ...
    public void getSaveList() {
        Call<List<SiteEditDao>> call = HttpManager.getInstance().getService().getSaveReportById("5");
